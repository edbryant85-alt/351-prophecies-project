351 Prophecies Project
Overview

This project is a structured, research-based examination of the claim that Jesus fulfilled 351 Old Testament prophecies.

The goal is to evaluate each claim using consistent criteria, original context, and supporting scholarship, rather than relying on isolated proof-texts or assumptions.
...
2) Predictive Intent – It must be intended as a forward-looking prediction
3) Non-Mundane – It must describe something unlikely or not easily generalized
4) Specific & Verifiable – It must point to a clear, identifiable event
